...
export const MeUserModel = {
  ...
  properties: {
    ...
    creator: {
      type: 'object',
      nullable: true,
      description: 'Populated when role is CREATOR. Null for LISTENER and ADMIN.',
      properties: {
        id: { ...UUIDField },
        ...
        slug: {
          type: 'string',
          example: 'wajahat-ali',
          description: 'URL-safe creator identifier. Used in public URLs: podara.io/c/wajahat-ali',
        },
        bio: {
          ...NullableStringField,
    ...
    listener: {
      type: 'object',
      nullable: true,
      description: 'Populated when role is LISTENER. Null for CREATOR and ADMIN.',
      properties: {
        id: { ...UUIDField },
...
export const TokenPairModel = {
  ...
  properties: {
    accessToken: {
      type: 'string',
      example: 'eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJ1dWlkIiwicm9sZSI6IkxJU1RFTkVSIn0.sig',
      description: 'JWT. Expires in 15 minutes. Send in Authorization: Bearer <token> header.',
    },
    refreshToken: {
      type: 'string',
      example: 'a3f9b2c1d4e5f6789abc0123456789abcdef0123456789abcdef0123456789ab',
      description:
...
export const AuthDataModel = {
  ...
  properties: {
    user: {
      ...UserModel,
      description: 'Minimal user object. Use GET /me for full profile with role-specific fields.',
    },
...
export function successResponse(
  ...
  return {
    ...
    properties: {
      ...
      ...(message !== undefined ? { message: { type: 'string', example: message } } : {}),
      data: dataModel,
    },
  }
}
 ...
 *   }
 */
export function commonErrors(codes: Array<'400' | '401' | '403' | '404' | '409' | '429' | '500'>) {
