      ...
      body: {
        ...
        properties: {
          ...
          role: {
            ...
            default: "LISTENER",
            description:
              "Defaults to LISTENER if omitted. ADMIN accounts are created manually.",
          },
          displayName: {
            type: "string",
            minLength: 2,
            ...
            example: "Wajahat Ali",
            description:
              "Required for CREATOR role. Falls back to email prefix if omitted.",
          },
          username: {
            type: "string",
            minLength: 2,
            ...
            example: "wajahat_ali",
            description:
              "Optional for LISTENER. Alphanumeric + underscores only.",
          },
        },
      },
      response: {
      ...
      body: {
        ...
        properties: {
          refreshToken: {
            ...
            description:
              "The refresh token from login or previous refresh call.",
          },
        },
      },
      response: {
